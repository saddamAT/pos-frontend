  ...
  return (
    ...
    >
      <p>
        ...
        <Link href='https://www.google.com.pk/' target='_blank' className='text-primary uppercase'>
          STech Experts
        </Link>
      </p>
      {!isBreakpointReached && (
        <div className='flex items-center gap-4'>
          ...
          <Link href='https://www.google.com.pk/' target='_blank' className='text-primary'>
            Support
          </Link>
        </div>
      )}
