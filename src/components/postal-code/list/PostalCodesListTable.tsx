...
import AddPostalCodeDrawer from '@/views/apps/wa-templates/add/AddPostalCodeDrawer'
...
const PostalCodesListTable = ({
  ...
  useEffect(() => {
    fetchPostalCodes()
  }, [addUserOpen, deletePostalCodesOpen, editPostalCodesFlag])
  ...
  const handleDeletePostalCode = (id: number) => {
    setDeletePostalCodesOpen(false)
