...
import SharjahPrintPageClient from './SharjahPrintPageClient'

type PrintOrderProps = {
  id: string
}

const SharjahPrintOrder = ({ id }: PrintOrderProps) => {
...
export default SharjahPrintOrder
